...
class ObjectDetector:
    def __init__(self, model_dir):
        ...
        """
        model_cfg = os.path.join(model_dir, "classifier.cfg")
        model_weights = os.path.join(model_dir, "classifier.weights")
        model_labels = os.path.join(model_dir, "classifier.names")
